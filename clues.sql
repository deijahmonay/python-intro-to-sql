...
-- Write SQL query here
SELECT countries.name, countries.code, countries.region, countrylanguages.language
...
--              name              | code |     region      | language 
-- -------------------------------+------+-----------------+----------
--  Italy                         | ITA  | Southern Europe | Italian
--  San Marino                    | SMR  | Southern Europe | Italian
--  Holy See (Vatican City State) | VAT  | Southern Europe | Italian
-- (3 rows)
...
SELECT countries.code, countries.name, countries.region, cities.name FROM countries JOIN cities ON countries.code = cities.countrycode WHERE region = 'South America' AND cities.name LIKE '%San Mar%';
-- Write SQL query here

--  code |   name    |    region     |        name        
-- ------+-----------+---------------+--------------------
--  ARG  | Argentina | South America | General San Martín
-- (1 row)
...
-- Write SQL query here
SELECT district FROM cities WHERE name LIKE 'General San Mart%';
